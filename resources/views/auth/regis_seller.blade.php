                                ...
                                <div class="accordion mt-4" id="faqExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <b>Answer:</b> MaiSayur adalah toko online yang dapat digunakan untuk
                                                memesan sayuran melalui aplikasi berbasis website
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b> UTani Sayur menyediakan jasa pengiriman sesuai dengan harga
                                                dari masing-masing penjual sayur yang sudah ditentukan sesuai lokasi
                                                customer
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b> UTani Sayur dapat menerima pesana 24 jam, namun akan
