        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 mt-1">
                    <a href="{{ route('shop') }}" class="site-btn btn-block text-center"><i class="fas fa-fw fa-store"></i>
                        &nbsp;&nbsp;&nbsp;Kembali</a>
                </div>
                <div class="col-lg-7">
                    <div class="hero__search float-right">
                        <div class="hero__search__form">
                            <form action="{{ route('detail_shop', $store->id) }}" method="POST">
                                ...
                                <input type="text" placeholder="Cari Sayuran..." autocomplete="off" name="keyword"
